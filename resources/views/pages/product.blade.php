        ...
        <div class="product-main">
            ...
            <div class="product-desc">
                ...
                <div class="card padding-card">
                    <p>Actual Price <a href="{{route('listBid', ['auction' => $product->id])}}">{{ $product->bids->count() }} bids</a></p>
                    <p class="price">{{ $product->bids->max('amount') ?? $product->start_price }} UAH</p>
                </div>
                <div class="card padding-card">
                    @auth('web')
                        @if(auth()->id() === $product->user_id)
                            <a href="{{ route('edit.auction', ['auction' => $product->id]) }}" class="button edit-auction">Edit Auction</a>
                        @else
                            <form action="{{ route('addBid', ['auction' => $product->id]) }}" method="Post" class="add-bid">
                                @csrf
                                <p>Place a bid: </p>
